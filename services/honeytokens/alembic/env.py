"""Alembic migration environment for Honeytokens service.
...
``0002_tenant_rls`` installs. A service that migrates and serves under one
...
MIGRATION_URL_VARS = ("HONEYTOKEN_DATABASE_MIGRATION_URL", "DATABASE_MIGRATION_URL")
...
RUNTIME_URL_VARS = ("DATABASE_URL", "HONEYTOKEN_DATABASE_URL")
...
VERSION_TABLE = "alembic_version_honeytokens"
