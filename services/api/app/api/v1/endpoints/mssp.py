...
class PortfolioTenantOut(BaseModel):
    ...
    mttr_minutes: float | None = Field(
        description="Mean minutes to close, over the trailing 30 days. Null when this tenant closed no cases."
    )
...
# from cases the tenant actually closed and is null when they closed none.
