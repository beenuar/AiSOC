...
|-------|-------|------|----------|---------|-------|
| `region` | Sysdig region | select | yes | — | one of: `us1`, `us2`, `us3`, `us4`, `eu1`, `au1`, `me2` |
| `api_token` | API Token | secret | yes | — | **encrypted at rest** · Sysdig Secure API token. Settings → API → Tokens. Needs read access to Secure Events. |
