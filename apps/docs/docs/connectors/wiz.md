...
| `api_endpoint_url` | API Endpoint URL | string | yes | — | Your tenant's GraphQL API endpoint. |
| `auth_url` | Auth URL | string | no | `https://auth.app.wiz.io/oauth/token` | OAuth2 token endpoint. Override only for gov-cloud tenants. |
