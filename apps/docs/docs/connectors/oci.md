...
| `user_ocid` | User OCID | string | yes | — | — |
| `compartment_ocid` | Root compartment OCID | string | yes | — | — |
| `fingerprint` | API key fingerprint | string | yes | — | — |
| `private_key_pem` | API private key (PEM) | secret | yes | — | **encrypted at rest** · PEM-encoded RSA private key paired with the fingerprint above. |
| `region` | Region | select | yes | — | one of: `us-ashburn-1`, `us-phoenix-1`, `eu-frankfurt-1`, `eu-amsterdam-1`, `uk-london-1`, `ap-tokyo-1`, `ap-mumbai-1`, `ap-sydney-1`, … (10 total) |
