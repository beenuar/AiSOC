...
|-------|-------|------|----------|---------|-------|
| `site_url` | Confluence site URL | string | yes | — | — |
| `email` | Account email | string | yes | — | — |
| `api_token` | API token | secret | yes | — | **encrypted at rest** · Generate at https://id.atlassian.com/manage-profile/security/api-tokens |
