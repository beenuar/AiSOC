...
| `api_url` | API URL | string | no | `https://api.orcasecurity.io` | Override only if your tenant lives on a region-specific Orca endpoint. The default works for the standard commercial cloud. |
