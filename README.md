...
- **Analyst-override feedback loop** — analysts can correct AI verdicts (`true_positive`, `false_positive`, `benign`, `escalate`) in one click. Corrections flow into institutional memory and adjust FPR metrics automatically.
