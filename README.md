...
- **Detection-as-Code lifecycle** — propose → review → eval-gate → promote; CI rejects any candidate that regresses MITRE accuracy. [`apps/docs/docs/concepts/detection-as-code.md`](apps/docs/docs/concepts/detection-as-code.md) — and the 800+ native Sigma rules live in [`detections/`](detections/).
